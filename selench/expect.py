...
class Expect:
    """
    This class provides waiting methods for certain conditions to be met in a web page
    ...
    def element_to_be_clickable(self, mark: Element | str, timeout: int = None) -> None:
        """
        ...
        """
        wait = WebDriverWait(self._driver.webdriver, timeout) if timeout else self._driver.wait
        locator = (
            mark.webelement
    ...
    def element_to_be_visible(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def elements_to_be_visible(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def element_to_be_invisible(self, mark: Element | str, timeout: int = None) -> None:
        """
    ...
    def elements_to_be_invisible(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def element_to_be_stale(self, element: Element, timeout: int = None) -> None:
        """
    ...
    def element_to_have_text(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def element_text_to_contain(self, selector: str, text: str, timeout: int = None) -> None:
        """
    ...
    def element_text_to_be(self, selector: str, text: str, timeout: int = None) -> None:
        """
    ...
    def element_attribute_text_to_contain(
        self, selector: str, attribute: str, text: str, timeout: int = None
    ) -> None:
        """
    ...
    def element_to_be_checked(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def element_to_not_be_checked(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def element_to_be_present(self, selector: str, timeout: int = None) -> None:
        """
    ...
    def page_url_to_be(self, url: str, timeout: int = None) -> None:
        """
        ...
        """
        wait = WebDriverWait(self._driver.webdriver, timeout) if timeout else self._driver.wait
        wait.until(ec.url_to_be(url), f"{url} != {self._driver.url}")

    def page_url_to_contain(self, string: str, timeout: int = None) -> None:
        """
    ...
    def page_title_to_be(self, title: str, timeout: int = None) -> None:
        """
        ...
        """
        wait = WebDriverWait(self._driver.webdriver, timeout) if timeout else self._driver.wait
        wait.until(ec.title_is(title), f"`{title} != {self._driver.title}")

    def page_title_to_contain(self, string: str, timeout: int = None) -> None:
        """
